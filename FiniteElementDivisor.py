...
def divide_into_finite_elements(nodes, members, loads, num_elements):
    """
    Divides each member into a specified number of finite elements.
    ...
    members : list
        List of Member objects to be divided
    loads : list
        List of load objects 
    num_elements : int
        Number of finite elements to divide each member into
        
    Returns:
    --------
    list
        List of new Node objects
    list
        List of new Member objects after division
    list
        List of new load objects distributed to the finite elements
    """
    if num_elements <= 1:
