...
# Custom navigation menu with categories
with st.sidebar:
    st.title("Navigation")
    ...
    with col1:
        st.button("📊 Nodes", key="nav_nodes", use_container_width=True, 
                 help="Create and edit nodes")
    
    with col2:
        st.button("🔗 Members", key="nav_members", use_container_width=True,
                 help="Create and edit members")
    
    st.button("⚡ Loads", key="nav_loads", use_container_width=True,
             help="Apply loads to the structure")
    ...
    with col1:
        st.button("📈 First Order", key="nav_first", use_container_width=True,
                 help="Run First Order Analysis")
    
    with col2:
        st.button("📉 Second Order", key="nav_second", use_container_width=True,
                 help="Run Second Order Analysis")
    
    col1, col2 = st.sidebar.columns(2)
    
    with col1:
        st.button("🔄 Comparison", key="nav_comparison", use_container_width=True,
                 help="Compare analysis results")
    
    with col2:
        st.button("🔔 Dynamic", key="nav_dynamic", use_container_width=True,
...
if st.session_state.get('nav_nodes', False):
    st.switch_page("pages/01_Node_Input.py")
elif st.session_state.get('nav_members', False):
    st.switch_page("pages/02_Member_Input.py")
elif st.session_state.get('nav_loads', False):
    st.switch_page("pages/03_Load_Input.py")
elif st.session_state.get('nav_first', False):
    st.switch_page("pages/04_First_Order_Analysis.py")
elif st.session_state.get('nav_second', False):
    st.switch_page("pages/05_Second_Order_Analysis.py")
elif st.session_state.get('nav_comparison', False):
    st.switch_page("pages/06_Comparison.py")
elif st.session_state.get('nav_dynamic', False):
    st.switch_page("pages/07_Dynamic_Analysis.py")
